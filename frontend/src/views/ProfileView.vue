...
<div id="totop"></div>
    ...
    <!-- <twitterleftsidebar></twitterleftsidebar> -->
        ...
        <div class="middlecontainer">
            ...
            <section class="twitterprofile">
                ...
                <div class="bio">
                    ...
                    <p>Cricket fan |</p>
                    <span>@24News @sports</span> <br>
                    <span> <i class="fa fa-location-arrow "></i> Madhaya Pradesh, Satna. <a href="#"> <i
                                class="fa fa-external-link" aria-hidden="true"></i>linkedin.com/link/ </a> <i
                            class="fa fa-birthday-cake" aria-hidden="true"></i> Born November 10</span>
                    <br> <span><i class="fa fa-calendar"></i> Joined june 2023</span>
                    <div class="nawa">
            ...
            <section class="mytweets">
                ...
                <div class="tweetbody">
                    <div>Ashish23 @Ashish23 - jun. 30</div>
                    <div class="tweetcontent"> My First tweet <br> do not  mislead with their tweets.</div>
        ...
        <div class="rightcontainer">
            ...
            <section class="nigeriatrends">
                ...
                <div class="trenditem">
                    ...
                    <div class="hashtag"> Virat Kohli</div>
...
<script>
import twitterleftsidebar from '@/components/twitterLeftsidebar.vue'
